  ...
  <body>
      ...
      <form id="loginForm" action="doLogin" method="post" class="form-signin" role="form">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-user"></i> 用户登录</h2>
		  <div class="form-group has-success has-feedback">
			<input type="text" class="form-control" id="lastName" name="lastName" placeholder="请输入登录名" autofocus>
			<span class="glyphicon glyphicon-user form-control-feedback"></span>
		  </div>
		  <div class="form-group has-success has-feedback">
			<input type="text" class="form-control" id="email" name="email" placeholder="请输入登录邮箱" style="margin-top:10px;">
    ...
    function dologin() {
        ...
        $.ajax({
            ...
            beforeSend : function () {
                loginIndex = layer.msg('处理中', {icon : 16});
            },
        ...
        // JSON 对象
        var json = {name : 'name1',age : 20};
        var jsons = [{name : 'name2',age : 20},
                    {name : 'name3',age : 20},
                    {name : 'name4',age : 20}];
