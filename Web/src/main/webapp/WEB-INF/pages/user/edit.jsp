			  ...
			  <div class="panel-body">
				<form id="userForm" role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="loginacct" value="${employee.id}" placeholder="请输入登陆账号">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" class="form-control" id="username" value="${employee.lastName}" placeholder="请输入用户名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">邮箱地址</label>
					<input type="email" class="form-control" id="email" value="${employee.email}" placeholder="请输入邮箱地址">
